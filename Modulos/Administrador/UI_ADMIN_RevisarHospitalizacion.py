...
class VentanaRevisarHospitalizacion(QMainWindow):
    def __init__(self, nombre_usuario="Admin"):
        ...
        self.setWindowTitle("Sistema Veterinario Yuno - Historial Hospitalizaciones (Admin)")
    ...
    def setup_table(self):
        # Columnas: ID Hosp, Fecha (Consulta), Mascota, Observaciones
        self.table = QTableWidget()
        self.table.setColumnCount(4)
        self.table.setHorizontalHeaderLabels(["ID", "Fecha Ingreso", "Mascota", "Observaciones"])
    ...
    def cargar_datos_tabla(self):
        ...
        try:
            ...
            for row_idx, row_data in enumerate(datos):
                ...
                # row_data = (id_hosp, fecha, nombre_mascota, observaciones)
