...
class MainWindow(QMainWindow):
    ...
    def setup_register_form(self, parent_layout):
        ...
        inp_direccion.setPlaceholderText("Ej: Av. Principal #123")
        ...
        inp_telefono.setPlaceholderText("Ej: 555-1234")
        ...
        grid_layout.addWidget(inp_apellido, 1, 1)

        grid_layout.addWidget(lbl_correo, 2, 0)
        grid_layout.addWidget(inp_correo, 2, 1)

        grid_layout.addWidget(lbl_direccion, 3, 0)
        grid_layout.addWidget(inp_direccion, 3, 1)

        grid_layout.addWidget(lbl_telefono, 4, 0)
        grid_layout.addWidget(inp_telefono, 4, 1)
    ...
    def upload_photo(self):
        ...
        if file_name:
            ...
            self.img_placeholder.setStyleSheet("border: none; border-radius: 10px;")
