...
try:
    ...
    class Conexion:
        def insertar_datos(self, t, d, c): return 999 
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, nombre_usuario="Recepcionista"): 
        ...
        self.white_layout.addStretch(1) # Empuja contenido hacia arriba
    ...
    def setup_sidebar(self):
        ...
        # 2. MARGEN INFERIOR A 50 (CRÍTICO PARA VER EL BOTÓN)
    ...
    def setup_accordion_group(self, title, options):
        ...
        for opt_text in options:
            ...
            btn_sub.clicked.connect(lambda checked=False, c=title, o=opt_text: self.abrir_ventana(c, o))
    ...
    def setup_register_form(self, parent_layout):
        ...
        grid.addWidget(l_n, 5, 0); grid.addWidget(w_nums, 5, 1)

        l_c = QLabel("Colonia/CP:"); l_c.setStyleSheet(style_lbl)
        grid.addWidget(l_c, 6, 0); grid.addWidget(w_col, 6, 1)
    ...
    def setup_info_board(self, parent_layout):
        ...
        vl.addWidget(h); h.setLayout(QVBoxLayout()); h.layout().addWidget(QLabel("Información", alignment=Qt.AlignmentFlag.AlignCenter, styleSheet="color: white; font-weight: bold; font-size: 18px; background: transparent;"))
