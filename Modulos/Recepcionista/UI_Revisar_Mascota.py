...
class MainWindow(QMainWindow):
    def __init__(self, nombre_usuario="Recepcionista"):
        ...
        # 1. CORRECCIÓN: Tamaño inicial y mínimo para evitar que se vea "miniatura"
        ...
        # Márgenes ajustados para que no se coma espacio en pantallas pequeñas
        self.white_layout.setContentsMargins(50, 30, 50, 30)

        # Header (Solo título, SIN botón volver arriba)
        ...
        # Columna Izquierda (Datos Mascota) - SIN BARRA ROSA
    ...
    def setup_sidebar(self):
        ...
        # 2. CORRECCIÓN: Márgenes optimizados para que el botón Volver no desaparezca
    ...
    def setup_pet_data(self, parent_layout):
        ...
        # 3. CORRECCIÓN: Eliminada la barra rosa (Botón Editar)
        
        parent_layout.addWidget(data_widget, stretch=3)

    def setup_right_panel(self, parent_layout):
        """Configura el panel derecho igual a Revisar Cliente."""
        ...
        lbl_photo_text = QLabel("Foto de la Mascota")
        ...
        lbl_text = QLabel(
            "Mascota ingresada el 15/10/2024.\n"
            "Vacunas al día.\n"
            "Dueño: Juan Pérez."
        )
