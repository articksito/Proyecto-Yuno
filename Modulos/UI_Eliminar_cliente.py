...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Header con Título y Botón Volver (Icono Undo)
    ...
    def setup_info_board(self, parent_layout):
        ...
        txt_motivo.setPlaceholderText("Ingrese el motivo del cambio...")
        txt_motivo.setPlainText("Actualización de dirección de residencia y número de contacto.") # Texto precargado
